...
<title>Voters- Registartion Form</title>
						...
						<form action="register" method="post" class="register-form"
							...
							<div class="form-group">
								<label for="email"><i class="zmdi zmdi-email"></i></label> <input
									type="email" name="emailid" id="email" placeholder="Your Email" required />
							</div>
							...
							<div class="form-group">
								<label for="contact"><i class="zmdi zmdi-badge-check"></i></label>
								<input type="text" name="adharno" id="contact"
									placeholder="ADhar Number.."    pattern="[2-9][0-9]{11}"
									title="Enter Valid Adhar Number..."
      								  required />
							</div>
							<div class="form-group">
								<label for="contact"><i class="zmdi zmdi-headset-mic"></i></label>
